...
return [
    ...
    */
    ...
    'size'                 => [
        ...
        'string'  => 'Kolom :attribute harus :size characters.',
    ...
    */
    ...
    'custom' => [
        'nis' => [
            ...
            'string' => 'Kolom NISN harus diisi berupa string.',
            'size' => 'Kolom NISN harus diisi :size angka.',
            'unique' => 'NISN sudah terpakai.',
        ],
        'nama' => [
            'required' => 'Kolom NAMA harus diisi.',
            'string' => 'Kolom NAMA harus diisi berupa string.',
            'max' => 'Kolom NAMA tidak boleh lebih dari :max karakter.',
        ],
        'tgl_lahir' => [
            'required' => 'Kolom TANGGAL LAHIR harus diisi.',
            'date' => 'Kolom TANGGAL LAHIR harus diisi berupa format tanggal yang benar (tahun-bulan-tanggal).',
        ],
        'jenis_kelamin' => [
            'required' => 'Kolom JENIS KELAMIN harus diisi.',
            'in' => 'Kolom JENIS KELAMIN harus dipilih L atau P.',
        ],
    ],
